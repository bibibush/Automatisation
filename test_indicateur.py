...
planning_path = f'Production/Planification de la production/Semaine 48 - Planning Fabrication.xlsm'
save_path = f'Production/Planification de la production/Semaine 48 - Planning Fabrication.xlsm'
